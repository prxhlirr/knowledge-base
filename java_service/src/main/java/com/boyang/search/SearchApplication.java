...
public class SearchApplication {
    ...
    public CommandLineRunner initData(JdbcTemplate jdbc) {
        return args -> {
            ...
            // jdbc.execute("ALTER TABLE search_audit_log ADD COLUMN IF NOT EXISTS doc_search_enabled BOOLEAN DEFAULT false");
            // jdbc.execute("ALTER TABLE search_audit_log ADD COLUMN IF NOT EXISTS doc_search_ms INT DEFAULT 0");
            // jdbc.execute("ALTER TABLE search_audit_log ADD COLUMN IF NOT EXISTS doc_search_candidates INT DEFAULT 0");
            // jdbc.execute("ALTER TABLE search_audit_log ADD COLUMN IF NOT EXISTS doc_search_prefilter_applied BOOLEAN DEFAULT false");
